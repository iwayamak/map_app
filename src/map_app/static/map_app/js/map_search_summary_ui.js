(function(global) {
    function createSummaryUi(elements) {
        ...
        function syncFromCurrentSummaryDom() {
            ...
            if (elements.livePerformancesCount && elements.summaryTotalPerformances) {
                elements.livePerformancesCount.textContent = elements.summaryTotalPerformances.textContent || "0";
            }
        }
