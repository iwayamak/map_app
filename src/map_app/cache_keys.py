...
MAP_FILTERED_CACHE_VERSION_KEY = map_cache_key("cache_version:filtered_page")
MAP_SEARCH_API_CACHE_VERSION_KEY = map_cache_key("cache_version:search_api")
...
SITE_SETTINGS_CACHE_KEY = map_cache_key("sitesettings:pk1")
SITE_SETTINGS_DOMAIN_TERMS_CACHE_KEY = map_cache_key("sitesettings:terms:pk1")
